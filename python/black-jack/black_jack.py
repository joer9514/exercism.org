...
def value_of_ace(card_one: str, card_two: str) -> int:
    ...
    equal_cards = card_one == "A" or card_two == "A"
    more_than_10 = (value_card_one + value_card_two) > 10

    return 1 if (equal_cards or more_than_10) else 11
...
def is_blackjack(card_one: str, card_two: str) -> bool:
    ...
    _is_blackjack = (value_card_one == 10 or value_card_two == 10) and (
        card_one == "A" or card_two == "A"
    )

    return _is_blackjack
...
def can_double_down(card_one: str, card_two: str) -> bool:
    ...
    """
    total = (value_of_card(card_one) + value_of_card(card_two)) in (9, 10, 11)
    return total
